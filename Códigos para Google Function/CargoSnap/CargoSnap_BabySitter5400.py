...
table_name = os.getenv('Table_CargoSnap_BabySitter5400')
...
def main(data, context):
    ...
    while page <= max_pages:
        ...
        url = f'https://api.cargosnap.com/api/v2/forms/4137?format=json&token=[bjJ2TGlrWExDZmVHcmtjQ2Q0cldYcHdYWENGbG84MDBfMzQ1]&limit=200&startdate=2024-01-01&enddate=2099-12-31&page={page}'

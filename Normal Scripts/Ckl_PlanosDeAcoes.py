...
def main():
    ...
    try:
        ...
        for checklist_id in checklist_ids:
            ...
            while more_pages:
                url = f"https://api-analytics.checklistfacil.com.br/v1/action-plans?status=6&checklistId={checklist_id}&page={page}"
                ...
                sql_select = "SELECT id_Ckl FROM Ckl_CartaoVerde"

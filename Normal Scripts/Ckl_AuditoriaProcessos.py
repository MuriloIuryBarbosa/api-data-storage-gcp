...
token = os.getenv('Token_Ckl_AuditoriaProcessos')
table_name = os.getenv('Table_Ckl_AuditoriaProcessos2')
                ...
                for i, id in enumerate(ids_to_register, start=1):
                    try:
                        ...
                        if response.status_code == 200:
                            ...
                            sql = f"INSERT INTO {table_name} (id_Ckl, Checklist, Unidade, Usuario, Status, Assinatura, Avaliador, ColaboradoresAuditados, ProcessoAuditado, VeiculoAuditado, AlgumProcessoFoiInfligido, DataAplicacao) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"

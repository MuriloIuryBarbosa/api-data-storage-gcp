...
token = os.getenv('Token_Ckl_CartaoVerde')
table_name = os.getenv('Table_Ckl_CartaoVerde2')
                ...
                for i, id in enumerate(ids_to_register, start=1):
                    try:
                        ...
                        if response.status_code == 200:
                            ...
                            sql = f"INSERT INTO {table_name} (id_Ckl, ColaboradorReconhecido, AcaoPositiva, Status, Checklist, Unidade, Usuario, Assinatura, DataChecklist) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)"

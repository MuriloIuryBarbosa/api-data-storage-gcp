...
token = os.getenv('Token_Ckl_PlanosDeAcoes')
table_name = os.getenv('Table_Ckl_PlanosDeAcoes')
...
def main():
    ...
    try:
        ...
        for checklist_id in checklist_ids:
            ...
            while True:
                url = f"https://api-analytics.checklistfacil.com.br/v1/action-plans?checklistId={checklist_id}&page={page}"

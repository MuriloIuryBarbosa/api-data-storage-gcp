...
def main():
    ...
    try:
        ...
        while more_pages:
            ...
            url = f'https://api.cargosnap.com/api/v2/forms/4137?format=json&token=[{token}]&limit=200&startdate=2024-01-01&enddate=2099-12-31&page={page}'
            ...
            for item in ids_to_register:
                ...
                try:
                    ...
                    print(f"Registrando ID {id_BabySitter}")
